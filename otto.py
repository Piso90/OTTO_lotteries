import random
import time
#import os  _ solo per windows

#def clearScreen(): _ solo per windows
#    os.system("cls") _ solo per windows
...
print("----STARTING----")
time.sleep(1)
#clearScreen() _ solo per windows
print("")
...
if tipogioco >2:
    ...
    print("<< TERMINE PROGRAMMA >>")
if tipogioco == 0:
    print(nome, ", sarà per la prossima volta!")
    time.sleep(1)
    print("<< TERMINE PROGRAMMA >>")
quit()
